    ...
    <>
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 py-20">
        <header className="mb-12 animate-fade-in-up">
          <span className="text-[10px] uppercase tracking-[0.2em] text-void-accent mb-3 block">Research</span>
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-void-white leading-[1.15] mb-4">
            {post.title}
          </h1>
          <div className="flex items-center gap-3 text-xs text-void-muted">
